                    ...
                    error: function (jqXHR, textStatus, errorThrown) {
                        ...
                        if (jqXHR.responseJSON.errors) {
                            ...
                            for (var item in jqXHR.responseJSON.errors) {
                                if (jqXHR.responseJSON.errors[item] == 'validation.recaptcha') {
                                    messageText += '<li>Captcha verification exprired. Please check the box again.</li>';
                                } else {
                                    messageText += '<li>' + jqXHR.responseJSON.errors[item] + '</li>';
                                }
                            };

                            messageText += '</ul>';
                        } else {
                            var messageText = jqXHR.responseJSON.message;
                        }
